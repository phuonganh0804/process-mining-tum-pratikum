...
class TestStep1(unittest.TestCase):
    ...
    def test_L7(self):
        ...
        observed = self.x.step_1()
        expected = {('a', 'b'): 0.857, ('b', 'c'): 0.857, ('b', 'b'): 0.857, ('a', 'c'): 0.667}
        self.assertEqual(observed,expected)
    ...
    def test_flyer_instance(self):
        ...
        observed = self.x.step_1()
        expected = {('receive flyer order', 'design flyer'): 0.999, ('send draft to customer', 'print flyer'): 0.999, ('print flyer', 'deliver flyer'): 0.999, ('send draft to customer', 'design flyer'): 1.0, ('design flyer', 'send draft to customer'): 1.0}
        self.assertEqual(observed,expected)
